...
個人的には SCORE 関数がしっかり用意しているあたり、全文検索ソリューションらしさを感じて好きだった一方、まだまだサポートしていないクエリも多く、ログの解析やデータの抽出で使うにしてもすこし苦労する場面は多そうです。その点では、前の記事で紹介した [Open Distro for Elasticsearch SQL](/articles/aa7d9c12616cd4219503) の方が優れている印象でした。
